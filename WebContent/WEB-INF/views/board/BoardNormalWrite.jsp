...
<script type="text/javascript"
	src="assets/js/plugins/summernote-ko-KR.js"></script>
...
<body>
	...
	<!-- contents -->
	<section class="container mt80 mb80"> <!-- 제목 --> <article
		class="row">
	...
	</article> <!-- /.제목 --> <!-- 내용 --> <article class="row">
	<div class="col-lg-12 col-center">

		<form action="<c:url value="BoardNormalWrite"/>"
			method="post">
			...
			<div class="form-group">
				<label>작성자 이름:</label> <input type="text" class="form-control"
					name="writerName">
				<p class="help-block"></p>
			</div>
			<div class="form-group">
			...
			<!-- 심플캡챠 -->
			<img src="<c:url value="stickyCaptcha.png" />"><br /> Answer: <input
				name="answer" />
			<!-- 심플캡챠끝 -->
